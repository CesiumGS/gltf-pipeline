...
describe("gltfToGlb", () => {
  ...
  it("gltfToGlb processes glTF with KHR_meshopt_compression extension.", async () => {
  ...
  it("gltfToGlb processes glTF with KHR_meshopt_compression extension with separate resources.", async () => {
    const gltf = fsExtra.readJsonSync(gltfKhrMeshoptFallbackPath);
    const options = {
      separate: true,
      resourceDirectory: path.dirname(gltfKhrMeshoptFallbackPath),
