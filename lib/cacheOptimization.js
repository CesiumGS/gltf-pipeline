...
/**
 * Optimizes vertices and indices memory locations based on the Tipsify algorithm.
 *
 * @param {Object} gltf - An object holding a glTF hierarchy
 * @param {number} [cacheSize=24] - Size of vertex cache
 */
...
// Helper function to map accessor collections from the usageTable to an independent primitive (if there is one)
