...
function updateBinaryObject(gltf, pipelineExtras, name, offset) {
...
function getBinaryGltf(gltf, callback) {
    ...
    var pipelineExtras = buffers.binarya_glTF.extras._pipeline;
    var currentBinaryView = 0;

    currentOffset = updateBinaryObject(gltf, pipelineExtras, 'shaders', currentOffset);
    currentOffset = updateBinaryObject(gltf, pipelineExtras, 'images', currentOffset);
