...
function updateBinaryObject(gltf, body, name, offset) {
...
function getBinaryGltf(gltf, callback) {
    ...
    currentOffset = updateBinaryObject(gltf, body, 'shaders', currentOffset);
    currentOffset = updateBinaryObject(gltf, body, 'images', currentOffset);
