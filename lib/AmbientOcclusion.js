...
/*module.exports = {
    ...
    extractInstructionWithFunctionCall: extractInstructionWithFunctionCall,
    injectGlslAfterInstructionContaining: injectGlslAfterInstructionContaining
};*/
...
module.exports = AmbientOcclusion;

/**
 * Pipeline stage and utilities for generating ambient occlusion.
 * @constructor
 */
function AmbientOcclusion() {}

/**
 * Bakes ambient occlusion (AO) to all models in a specific scene of the gltf.
 *
 * @param {Object} aoOptions All options for baking AO including a gltf with extras and AO parameters
 * @param {Object} aoOptions.gltfWithExtras A gltf with standard pipeline extras
 *
 * Basic options:
 ...
 * @see loadGltfUris
 */
AmbientOcclusion.bakeAmbientOcclusion = function(aoOptions) {
...
AmbientOcclusion.generateOptions = generateOptions;
AmbientOcclusion.generateRaytracerScene = generateRaytracerScene;
AmbientOcclusion.computeAmbientOcclusionAt = computeAmbientOcclusionAt;
AmbientOcclusion.raytraceAtTriangleCenters = raytraceAtTriangleCenters;
AmbientOcclusion.raytraceOverTriangleSamples = raytraceOverTriangleSamples;
AmbientOcclusion.extractInstructionWithFunctionCall = extractInstructionWithFunctionCall;
AmbientOcclusion.injectGlslAfterInstructionContaining = injectGlslAfterInstructionContaining;
