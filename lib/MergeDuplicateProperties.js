 ...
 */
MergeDuplicateProperties.mergeAllDuplicates = function(gltf) {
    MergeDuplicateProperties.mergeDuplicateAccessors(gltf);
    MergeDuplicateProperties.mergeDuplicateShaders(gltf);
    MergeDuplicateProperties.mergeDuplicatePrograms(gltf);
    MergeDuplicateProperties.mergeDuplicateTechniques(gltf);
    MergeDuplicateProperties.mergeDuplicateMaterials(gltf);
};
 ...
 * @see loadGltfUris
 */
MergeDuplicateProperties.mergeDuplicateAccessors = function(gltf) {
 ...
 */
MergeDuplicateProperties.mergeDuplicateShaders = function(gltf) {
 ...
 */
MergeDuplicateProperties.mergeDuplicatePrograms = function(gltf) {
    var programs = gltf.programs;
 ...
 */
MergeDuplicateProperties.mergeDuplicateTechniques = function(gltf) {
    var techniques = gltf.techniques;
 ...
 */
MergeDuplicateProperties.mergeDuplicateMaterials = function(gltf) {
    var materials = gltf.materials;
