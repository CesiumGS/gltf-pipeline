...
var moveBlendingToExtension = require('./moveBlendingToExtension');
...
function objectsToArrays(gltf) {
    ...
    ForEach.techniqueLegacy(gltf, function(technique) {
        ...
        ForEach.techniqueParameterLegacy(technique, function(parameter) {
    ...
    ForEach.material(gltf, function(material) {
        ...
        ForEach.materialValueLegacy(material, function(value, name) {
            if (typeof value === 'string') {
        ...
        if (defined(extensions)) {
            ...
            if (defined(materialsCommon)) {
                ForEach.materialValueLegacy(materialsCommon, function(value, name) {
                    if (typeof value === 'string') {
...
function glTF10to20(gltf) {
    ...
    // Add blending functions to EXT_blend extension, removing technique render states
    moveBlendingToExtension(gltf);
