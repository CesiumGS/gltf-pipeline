...
function readFile(object, uri, options) {
    ...
    if (!defined(resourceDirectory)) {
        ...
        relativePath = path.relative(resourceDirectory, absolutePath);
    }

    if (options.secure && relativePath.indexOf('..') === 0) {
