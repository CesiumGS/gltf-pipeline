...
function sumBarycentric(barycentric, vector0, vector1, vector2, result) {
    ...
    result.x = barycentric.x * vector0.x;
    result.y = barycentric.x * vector0.y;
    result.z = barycentric.x * vector0.z;

    result.x += barycentric.y * vector1.x;
    result.y += barycentric.y * vector1.y;
    result.z += barycentric.y * vector1.z;

    result.x += barycentric.z * vector2.x;
    result.y += barycentric.z * vector2.y;
    result.z += barycentric.z * vector2.z;
