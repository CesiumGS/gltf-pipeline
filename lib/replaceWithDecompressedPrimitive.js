 ...
 * @private
 */
function replaceWithDecompressedPrimitive(gltf, primitive, encodedPointsCount, encodedFacesCount, compressedData, fallback) {
    var decoder = new decoderModule.Decoder();
    var dracoGeometry = decompressDracoBuffer(decoder, compressedData);
    ...
    if (fallback) {
        var indicesBuffer = getIndicesBuffer(gltf, indicesAccessor, decoderModule, decoder, dracoGeometry, encodedFacesCount);
