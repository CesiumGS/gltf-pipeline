...
var mergeDuplicateMaterials = require('./mergeDuplicateMaterials');
var mergeDuplicatePrograms = require('./mergeDuplicatePrograms');
var mergeDuplicateShaders = require('./mergeDuplicateShaders');
var mergeDuplicateTechniques = require('./mergeDuplicateTechniques');
...
Pipeline.processJSONWithExtras  = function(gltfWithExtras, options) {
    ...
    mergeDuplicateShaders(gltfWithExtras);
    mergeDuplicatePrograms(gltfWithExtras);
    mergeDuplicateTechniques(gltfWithExtras);
    mergeDuplicateMaterials(gltfWithExtras);
