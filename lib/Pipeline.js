...
var compressTexturesMultipleFormats = require('./compressTexturesMultipleFormats');
    ...
    return Promise.all(waitForStages)
        .then(function() {
            ...
            if (defined(textureCompressionOptions)) {
                if (isArray(textureCompressionOptions)) {
                    return compressTexturesMultipleFormats(gltfWithExtras, textureCompressionOptions);
                } else {
