...
module.exports = {
    processJSON : Pipeline.processJSON,
    processJSONWithExtras : Pipeline.processJSONWithExtras,
    processFile : Pipeline.processFile,
    processJSONToDisk : Pipeline.processJSONToDisk,
    processFileToDisk : Pipeline.processFileToDisk
};
...
Pipeline.processJSONWithExtras  = function(gltfWithExtras, options) {
    ...
    // mergeDuplicateVertices(gltfWithExtras);
    // TODO: optimizeForVertexCache crashes when the BATCH_ID semantic is present
