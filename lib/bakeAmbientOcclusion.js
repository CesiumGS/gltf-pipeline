...
function flattenTriangle(positions, results) {
    ...
    results[0].x = 0.0;
    results[0].y = 0.0;
    results[1].x = pointLineDistanceParametric(positions[1], positions[0], yAxis);
    results[1].y = pointLineDistanceParametric(positions[1], positions[0], xAxis);
    results[2].x = pointLineDistanceParametric(positions[2], positions[0], yAxis);
    results[2].y = pointLineDistanceParametric(positions[2], positions[0], xAxis);
