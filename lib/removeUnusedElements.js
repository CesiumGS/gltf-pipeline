...
/**
 * Contains functions for converting a type to a glTF element name.
 * @constructor
 */
function TypeToGltfElementName() {}

TypeToGltfElementName.accessor = function() {
    return 'accessors';
};

TypeToGltfElementName.buffer = function() {
    return 'buffers';
};
