...
function compressTextureCoordinates(gltf) {
    ...
    getAccessorsForSemantic(gltf, 'TEXCOORD', function(gltf, primitive, semantic, accessorId) {
...
function canCompress(accessor) {
    return accessor.type === 'VEC2' && accessor.componentType === WebGLConstants.FLOAT;
}
