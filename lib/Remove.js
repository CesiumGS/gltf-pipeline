...
Remove.accessor = function(gltf, accessorId) {
    ...
    ForEach.mesh(gltf, function(meshId, mesh) {
        ForEach.meshPrimitives(mesh, function(i, primitive) {
            ForEach.meshPrimitiveAttributes(primitive, function(semantic, attributeAccessorId) {
...
Remove.node = function(gltf, nodeId) {
    ...
    /* jshint unused:vars */
    ForEach.node(gltf, function(id, node) {
    ...
    ForEach.scene(gltf, function(sceneId, scene) {
