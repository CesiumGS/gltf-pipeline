...
/**
 * Iterates through meshes on the glTF asset, looking for primitives
 * with the BATCHID semantic. This semantic is used by 3D Tiles.
 * Techniques, programs and shaders for the primitive's material
 * need to have this semantic added back if it was stripped out during
 * processing, and this stage performs that operation.
 *
 * @param {Object} gltf A javascript object containing a glTF asset.
 *
 * @returns {Object} The glTF asset with patched materials.
 */
