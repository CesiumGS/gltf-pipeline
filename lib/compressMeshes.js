...
/**
 * Compresses all the meshes using Draco compression.
 *
 * @param {Object} gltf A javascript object containing a glTF asset.
...
function compressMeshes(gltf, options) {
    ...
    var normalQuantization = options.dracoOptions.quantizeNormal === undefined ? 10 : options.dracoOptions.quantizeNormal;
    var texcoordQuantization = options.dracoOptions.quantizeTexcoord === undefined ? 12 : options.dracoOptions.quantizeTexcoord;
    var colorQuantization = options.dracoOptions.quantizeColor === undefined ? 8 : options.dracoOptions.quantizeColor;
    var skinQuantization = options.dracoOptions.quantizeSkin === undefined ? 12 : options.dracoOptions.quantizeSkin;
    var useUnifiedQuantization = options.dracoOptions.unifiedQuantization === undefined ? false : options.dracoOptions.unifiedQuantization;
