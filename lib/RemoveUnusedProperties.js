 ...
 */
RemoveUnusedProperties.removeAllUnused = function(gltf) {
    RemoveUnusedProperties.removeUnusedNodes(gltf);
    RemoveUnusedProperties.removeUnusedSkins(gltf);
    RemoveUnusedProperties.removeUnusedCameras(gltf);
    RemoveUnusedProperties.removeUnusedMeshes(gltf);
    RemoveUnusedProperties.removeUnusedAccessors(gltf);
    RemoveUnusedProperties.removeUnusedMaterials(gltf);
    RemoveUnusedProperties.removeUnusedBufferViews(gltf);
    RemoveUnusedProperties.removeUnusedTechniques(gltf);
    RemoveUnusedProperties.removeUnusedTextures(gltf);
    RemoveUnusedProperties.removeUnusedBuffers(gltf);
    RemoveUnusedProperties.removeUnusedPrograms(gltf);
    RemoveUnusedProperties.removeUnusedImages(gltf);
    RemoveUnusedProperties.removeUnusedSamplers(gltf);
    RemoveUnusedProperties.removeUnusedShaders(gltf);
    RemoveUnusedProperties.removeUnusedPrimitiveAttributes(gltf);
};
 ...
 */
RemoveUnusedProperties.removeUnusedNodes = function(gltf) {
    var usedNodeIds = {};
 ...
 */
RemoveUnusedProperties.removeUnusedSkins = function(gltf) {
 ...
 */
RemoveUnusedProperties.removeUnusedCameras = function(gltf) {
 ...
 */
RemoveUnusedProperties.removeUnusedMeshes = function(gltf) {
    var usedMeshIds = {};
    var nodes = gltf.nodes;
 ...
 */
RemoveUnusedProperties.removeUnusedAccessors = function(gltf) {
    var usedAccessorIds = {};
 ...
 */
RemoveUnusedProperties.removeUnusedMaterials = function(gltf) {
    var usedMaterialIds = {};
    var meshes = gltf.meshes;
 ...
 */
RemoveUnusedProperties.removeUnusedBufferViews = function(gltf) {
 ...
 */
RemoveUnusedProperties.removeUnusedTechniques = function(gltf) {
 ...
 */
RemoveUnusedProperties.removeUnusedTextures = function(gltf) {
    var usedTextureIds = {};
 ...
 */
RemoveUnusedProperties.removeUnusedBuffers = function(gltf) {
 ...
 */
RemoveUnusedProperties.removeUnusedPrograms = function(gltf) {
 ...
 * @returns {Object} The glTF asset with removed unused images.
 */
RemoveUnusedProperties.removeUnusedImages = function(gltf) {
 ...
 */
RemoveUnusedProperties.removeUnusedSamplers = function(gltf) {
 ...
 */
RemoveUnusedProperties.removeUnusedShaders = function(gltf) {
    var usedShaderIds = {};
 ...
 */
RemoveUnusedProperties.removeUnusedPrimitiveAttributes = function(gltf) {
    var meshes = gltf.meshes;
    var materials = gltf.materials;
    var techniques = gltf.techniques;
    for (var meshId in meshes) {
