...
function parseBinaryGltf(data) {
        ...
        if (defined(bufferViews)) {
            ...
            for (var bufferViewId in bufferViews) {
                if (bufferViews.hasOwnProperty(bufferViewId)) {
                    ...
                    bufferView.extras._pipeline.deleteExtras = true; //Move to addPipelineExtras
                }
            }
    ...
    // fs.writeFile('parsedBinaryGltf.gltf', JSON.stringify(gltf, undefined, 2));
        ...
        for (var objectId in objects) {
            if (objects.hasOwnProperty(objectId)) {
                ...
                if (defined(objectExtensions) && defined(objectExtensions.KHR_binary_glTF)) {
                    ...
                    object.extras._pipeline.deleteExtras = true; //Move to addPipelineExtras
