...
function generateFaceNormals(gltf, primitive, positionSemantic) {
    ...
    var positions = generateAttributes[positionSemantic].original;
    ...
    attributes.NORMAL = createAccessor(gltf, packArray(generatedNormals, 'VEC3'), 'VEC3', WebGLConstants.FLOAT, WebGLConstants.ARRAY_BUFFER);
