...
function compressDracoMeshes(gltf, options) {
    ...
    ForEach.mesh(gltf, function(mesh) {
        ForEach.meshPrimitive(mesh, function(primitive) {
            ...
            console.log('numPoints:' + encodedPointsCount.toString() + ' numFaces:' + encodedFacesCount.toString());
...
function addCompressionExtensionToPrimitive(gltf, primitive, attributeToId, encodedLength, encodedData, encodedPointsCount, encodedFacesCount) {
    ...
    gltf = replaceWithDecompressedPrimitive(gltf, primitive, encodedData, encodedPointsCount, encodedFacesCount, primitive.extensions.KHR_draco_mesh_compression);
}
