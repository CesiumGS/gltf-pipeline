...
function addPipelineExtras(gltf) {
    ...
    gltf.asset.profile = defaultValue(gltf.asset.profile, {});
    gltf.asset.profile.extras = defaultValue(gltf.asset.profile.extras, {});
    gltf.asset.profile.extras._pipeline = defaultValue(gltf.asset.profile.extras_pipeline, {});
    return gltf;
}