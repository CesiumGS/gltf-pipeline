...
// Helper function for packing Cartesians to arrays
function packArray(values) {
    ...
    switch (values.type) {
        case 'Cartesian2':
            ...
            Cartesian2.packArray(values.data, packed);
            return packed;
        case 'Cartesian3':
            packed = new Array(length * 3);
            Cartesian3.packArray(values.data, packed);
            return packed;
        case 'Cartesian4':
            packed = new Array(length * 4);
            Cartesian4.packArray(values.data, packed);
            return packed;
    }
}
