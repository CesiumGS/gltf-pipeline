 ...
 * @private
 */
function mergeBuffers(gltf, uncompressedFallback) {
    var bufferList = getBufferList(gltf, uncompressedFallback);
...
function getBufferList(gltf, uncompressedFallback) {
    var bufferList = [];
    if (uncompressedFallback) {
        bufferList = getBufferListWithFallback(gltf);
    } else {
...
function getBufferListWithFallback(gltf) {
