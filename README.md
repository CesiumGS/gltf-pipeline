...
|`--ao`|Bake ambient occlusion to vertex data using default settings if no others are specified. Advanced settings in `lib/bakeAmbientOcclusion.js`|No, default `false`|
